                        ...
                        <form autocomplete="off">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4">
                                    ...
                                    <div class="mb-1">
                                        <label for="idNumber" class="form-label">Identity Typ<span class="text-danger text-lg">*</span>e</label>
                                        <select class="form-select" id="idType" required>
                                            <option value="">Select Identity Type</option>
                                        </select>
                                    </div>
                                    <div class="mb-2">
                                        <label for="idNumber" class="form-label">Identity idNumber<span class="text-danger text-lg">*</span></label>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-2">
                                        <label for="socialAssistanceProgramme" class="form-label">Social Assistance Programme</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#applicationModal').on('show.bs.modal', function(e) {
            ...
            populateDropdown('/marital_statuses', '#marital_status', 'Select');
    ...
    $('#applicationForm').on('submit', function(event) {
        ...
        if (isValid) {
            ...
            // Send AJAX request
            $.ajax({
                url: '/submit-application', // Replace with your actual endpoint
                method: 'POST',
                data: formData,
